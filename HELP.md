...
* The original package name 'alexis.springframework.mssc-brewery' is invalid and this project uses 'alexis.springframework.msscbrewery' instead.
...
* [Spring Boot Actuator](https://docs.spring.io/spring-boot/docs/3.3.0-M1/reference/htmlsingle/index.html#actuator)
